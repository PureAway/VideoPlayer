...
import com.zcy.player.render.view.IRenderView;
import com.zcy.player.render.view.VideoGLView;
import com.zcy.player.render.view.VideoSurfaceView;
import com.zcy.player.render.view.VideoTextureView;
...
public class RenderView {
    ...
    public void addView(final Context context, final ViewGroup textureViewContainer, final int rotate,
        ...
        if (VideoType.getRenderType() == VideoType.SUFRACE) {
            mShowView = VideoSurfaceView.addSurfaceView(context, textureViewContainer, rotate, iSurfaceListener, videoParamsListener);
        } else if (VideoType.getRenderType() == VideoType.GLSURFACE) {
            mShowView = VideoGLView.addGLView(context, textureViewContainer, rotate, iSurfaceListener, videoParamsListener, effect, transform, customRender, mode);
        } else {
            mShowView = VideoTextureView.addTextureView(context, textureViewContainer, rotate, iSurfaceListener, videoParamsListener);
        }
    }
