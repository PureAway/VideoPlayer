 ...
 */
package com.zcy.player.exoplayer2.source.dash;
...
import com.zcy.player.exoplayer2.ExoPlayerLibraryInfo;
import com.zcy.player.exoplayer2.ParserException;
import com.zcy.player.exoplayer2.Timeline;
import com.zcy.player.exoplayer2.drm.DrmSession;
import com.zcy.player.exoplayer2.drm.DrmSessionManager;
import com.zcy.player.exoplayer2.offline.FilteringManifestParser;
import com.zcy.player.exoplayer2.offline.StreamKey;
import com.zcy.player.exoplayer2.source.BaseMediaSource;
import com.zcy.player.exoplayer2.source.CompositeSequenceableLoaderFactory;
import com.zcy.player.exoplayer2.source.DefaultCompositeSequenceableLoaderFactory;
import com.zcy.player.exoplayer2.source.MediaPeriod;
import com.zcy.player.exoplayer2.source.MediaSource;
import com.zcy.player.exoplayer2.source.MediaSourceEventListener;
import com.zcy.player.exoplayer2.source.MediaSourceEventListener.EventDispatcher;
import com.zcy.player.exoplayer2.source.MediaSourceFactory;
import com.zcy.player.exoplayer2.source.SequenceableLoader;
import com.zcy.player.exoplayer2.source.dash.PlayerEmsgHandler.PlayerEmsgCallback;
import com.zcy.player.exoplayer2.source.dash.manifest.AdaptationSet;
import com.zcy.player.exoplayer2.source.dash.manifest.DashManifest;
import com.zcy.player.exoplayer2.source.dash.manifest.DashManifestParser;
import com.zcy.player.exoplayer2.source.dash.manifest.UtcTimingElement;
import com.zcy.player.exoplayer2.upstream.Allocator;
import com.zcy.player.exoplayer2.upstream.DataSource;
import com.zcy.player.exoplayer2.upstream.DefaultLoadErrorHandlingPolicy;
import com.zcy.player.exoplayer2.upstream.LoadErrorHandlingPolicy;
import com.zcy.player.exoplayer2.upstream.Loader;
import com.zcy.player.exoplayer2.upstream.Loader.LoadErrorAction;
import com.zcy.player.exoplayer2.upstream.LoaderErrorThrower;
import com.zcy.player.exoplayer2.upstream.ParsingLoadable;
import com.zcy.player.exoplayer2.upstream.TransferListener;
import com.zcy.player.exoplayer2.util.Assertions;
import com.zcy.player.exoplayer2.util.Log;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  public static final class Factory implements MediaSourceFactory {
     ...
     * com.zcy.player.exoplayer2.Timeline} of the source as {@link
     * com.zcy.player.exoplayer2.Timeline.Window#tag}.
     *
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
        com.zcy.player.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      com.zcy.player.exoplayer2.source.dash.manifest.Period period =
