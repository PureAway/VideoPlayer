package com.zcy.player.video.base;
...
import com.zcy.player.utils.OrientationOption;
import com.zcy.player.utils.OrientationUtils;
import com.zcy.player.view.SmallVideoTouch;
...
import static com.zcy.player.utils.CommonUtil.hideSupportActionBar;
import static com.zcy.player.utils.CommonUtil.showNavKey;
import static com.zcy.player.utils.CommonUtil.showSupportActionBar;
...
public abstract class BaseVideoPlayer extends VideoControlView {
    ...
    protected void cloneParams(BaseVideoPlayer from, BaseVideoPlayer to) {
        ...
        to.videoProgressListener = from.videoProgressListener;
    ...
    protected Runnable mCheckoutTask = new Runnable() {
        ...
        public void run() {
            ...
            if (fullWindowPlayer != null
                    && fullWindowPlayer.mCurrentState != mCurrentState) {
                if (fullWindowPlayer.mCurrentState == CURRENT_STATE_PLAYING_BUFFERING_START
                        && mCurrentState != CURRENT_STATE_PREPAREING) {
                    fullWindowPlayer.setStateAndUi(mCurrentState);
                }
            }
        }
    };
