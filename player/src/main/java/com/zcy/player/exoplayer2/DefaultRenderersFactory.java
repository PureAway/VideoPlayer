...
import com.zcy.player.exoplayer2.audio.AudioCapabilities;
import com.zcy.player.exoplayer2.audio.AudioProcessor;
import com.zcy.player.exoplayer2.audio.AudioRendererEventListener;
import com.zcy.player.exoplayer2.audio.DefaultAudioSink;
import com.zcy.player.exoplayer2.audio.MediaCodecAudioRenderer;
import com.zcy.player.exoplayer2.drm.DrmSessionManager;
import com.zcy.player.exoplayer2.drm.FrameworkMediaCrypto;
import com.zcy.player.exoplayer2.mediacodec.MediaCodecSelector;
import com.zcy.player.exoplayer2.metadata.MetadataOutput;
import com.zcy.player.exoplayer2.metadata.MetadataRenderer;
import com.zcy.player.exoplayer2.text.TextOutput;
import com.zcy.player.exoplayer2.text.TextRenderer;
import com.zcy.player.exoplayer2.trackselection.TrackSelector;
import com.zcy.player.exoplayer2.util.Log;
import com.zcy.player.exoplayer2.video.MediaCodecVideoRenderer;
import com.zcy.player.exoplayer2.video.VideoRendererEventListener;
import com.zcy.player.exoplayer2.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.zcy.player.exoplayer2.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
              com.zcy.player.exoplayer2.video.VideoRendererEventListener.class,
              int.class);
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.zcy.player.exoplayer2.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.zcy.player.exoplayer2.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              com.zcy.player.exoplayer2.audio.AudioRendererEventListener.class,
              com.zcy.player.exoplayer2.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.zcy.player.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              com.zcy.player.exoplayer2.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.zcy.player.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              com.zcy.player.exoplayer2.audio.AudioRendererEventListener.class,
