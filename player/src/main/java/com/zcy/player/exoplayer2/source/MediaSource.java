...
/**
 * Defines and provides media to be played by an {@link com.zcy.player.exoplayer2.ExoPlayer}. A
 ...
 * com.zcy.player.exoplayer2.ExoPlayer} Javadoc. They should not be called directly from
 * application code. Instances can be re-used, but only for one {@link
 * com.zcy.player.exoplayer2.ExoPlayer} instance simultaneously.
 */
