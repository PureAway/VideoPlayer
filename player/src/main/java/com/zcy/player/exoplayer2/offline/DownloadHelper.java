 ...
 */
package com.zcy.player.exoplayer2.offline;
...
import com.zcy.player.exoplayer2.RendererCapabilities;
import com.zcy.player.exoplayer2.RenderersFactory;
...
import com.zcy.player.exoplayer2.source.MediaSource.MediaPeriodId;
import com.zcy.player.exoplayer2.source.MediaSource.MediaSourceCaller;
...
import com.zcy.player.exoplayer2.trackselection.BaseTrackSelection;
import com.zcy.player.exoplayer2.trackselection.DefaultTrackSelector;
import com.zcy.player.exoplayer2.trackselection.DefaultTrackSelector.Parameters;
import com.zcy.player.exoplayer2.trackselection.DefaultTrackSelector.SelectionOverride;
import com.zcy.player.exoplayer2.trackselection.MappingTrackSelector.MappedTrackInfo;
import com.zcy.player.exoplayer2.trackselection.TrackSelection;
import com.zcy.player.exoplayer2.trackselection.TrackSelectorResult;
...
import com.zcy.player.exoplayer2.upstream.DataSource.Factory;
import com.zcy.player.exoplayer2.upstream.DefaultAllocator;
...
public final class DownloadHelper {
  ...
  private static final Constructor<? extends MediaSourceFactory> DASH_FACTORY_CONSTRUCTOR =
      getConstructor("com.zcy.player.exoplayer2.source.dash.DashMediaSource$Factory");

  @Nullable
  private static final Constructor<? extends MediaSourceFactory> SS_FACTORY_CONSTRUCTOR =
      getConstructor("com.zcy.player.exoplayer2.source.smoothstreaming.SsMediaSource$Factory");

  @Nullable
  private static final Constructor<? extends MediaSourceFactory> HLS_FACTORY_CONSTRUCTOR =
      getConstructor("com.zcy.player.exoplayer2.source.hls.HlsMediaSource$Factory");
