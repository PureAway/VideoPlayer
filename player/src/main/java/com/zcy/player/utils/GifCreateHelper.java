...
import com.zcy.player.listener.VideoGifSaveListener;
...
public class GifCreateHelper {
    ...
    private VideoGifSaveListener videoGifSaveListener;
    ...
    public GifCreateHelper(StandardVideoPlayer standardVideoPlayer, VideoGifSaveListener videoGifSaveListener) {
    ...
    public GifCreateHelper(StandardVideoPlayer standardVideoPlayer, VideoGifSaveListener videoGifSaveListener,
        ...
        this.videoGifSaveListener = videoGifSaveListener;
        mDelay = delay;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if (mPicList.size() > 2) {
                    ...
                    createGif(path, mPicList, mDelay, mSampleSize, mScaleSize, videoGifSaveListener);
                } else {
                    videoGifSaveListener.result(false, null);
                }
            }
        }).start();
    }
    ...
    private void startSaveBitmap() {
        ...
        File file = new File(mTmpPath, "TMP-FRAME" + System.currentTimeMillis() + ".tmp");
