...
import com.zcy.player.render.glrender.VideoGLViewSimpleRender;
import com.zcy.player.render.view.listener.GLSurfaceListener;
import com.zcy.player.render.view.listener.VideoGLRenderErrorListener;
...
public class VideoGLView extends GLSurfaceView implements GLSurfaceListener, IRenderView, MeasureHelper.MeasureFormVideoParamsListener {
    ...
    public void setOnSurfaceListener(GLSurfaceListener glSurfaceListener) {
    ...
    public static VideoGLView addGLView(final Context context, final ViewGroup textureViewContainer, final int rotate,
        ...
        videoGLView.setISurfaceListener(iSurfaceListener);
