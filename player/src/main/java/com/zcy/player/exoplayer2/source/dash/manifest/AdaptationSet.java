...
public class AdaptationSet {
  ...
  /**
   * The type of the adaptation set. One of the {@link com.zcy.player.exoplayer2.C}
   ...
   * @param type The type of the adaptation set. One of the {@link com.zcy.player.exoplayer2.C}
   *     {@code TRACK_TYPE_*} constants.
