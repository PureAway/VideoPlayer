 ...
 */
package com.zcy.player.exoplayer2.extractor;

import com.zcy.player.exoplayer2.extractor.amr.AmrExtractor;
import com.zcy.player.exoplayer2.extractor.flac.FlacExtractor;
import com.zcy.player.exoplayer2.extractor.flv.FlvExtractor;
...
import com.zcy.player.exoplayer2.extractor.mp4.Mp4Extractor;
import com.zcy.player.exoplayer2.extractor.ogg.OggExtractor;
import com.zcy.player.exoplayer2.extractor.ts.Ac3Extractor;
import com.zcy.player.exoplayer2.extractor.ts.Ac4Extractor;
import com.zcy.player.exoplayer2.extractor.ts.AdtsExtractor;
import com.zcy.player.exoplayer2.extractor.ts.DefaultTsPayloadReaderFactory;
import com.zcy.player.exoplayer2.extractor.ts.PsExtractor;
import com.zcy.player.exoplayer2.extractor.ts.TsExtractor;
import com.zcy.player.exoplayer2.extractor.ts.TsPayloadReader;
import com.zcy.player.exoplayer2.extractor.wav.WavExtractor;
  ...
  static {
    ...
    try {
      ...
      boolean isFlacNativeLibraryAvailable =
          Boolean.TRUE.equals(
              Class.forName("com.zcy.player.exoplayer2.ext.flac.FlacLibrary")
                  .getMethod("isAvailable")
                  .invoke(/* obj= */ null));
      if (isFlacNativeLibraryAvailable) {
        flacExtensionExtractorConstructor =
            Class.forName("com.zcy.player.exoplayer2.ext.flac.FlacExtractor")
